...
self.sendcodemail = async( correo, code) =>{
    try {
        ...
        const sesClient = new SES.SESClient({ region: process.env.AWS_REGION })
        ...
        let params = {
          ...
          await new sesClient.SES({apiVersion: '2010-12-01'}).sendTemplatedEmail(params).promise();
