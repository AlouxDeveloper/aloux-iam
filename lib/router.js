...
const uploadFile = fileupload({ useTempFiles: true, tempFileDir: "/tmp/" });
...
router.put("/iam/auth/profile/pictura", middleware, uploadFile, auth.updatePicture);
...
router.get("/iam/auth/sessions", middleware, auth.sessions);
router.delete("/iam/auth/sessions/:id", middleware, auth.revokeSession);
...
router.post("/iam/user/service", middleware, user.createService);
...
router.get("/iam/business/my/company/:COMPANY_ID", middleware, business.retrieveMyCompany);
...
router.patch("/iam/business/:BUSINESS_ID/picture", middleware, uploadFile, business.picture);
router.patch("/iam/business/:BUSINESS_ID/favicon", middleware, uploadFile, business.favicon);
router.get("/iam/business/:ID/identity", middleware, business.identity);
...
router.patch("/iam/company/:COMPANY_ID/picture", middleware, uploadFile, company.picture);
router.patch("/iam/company/:COMPANY_ID/favicon", middleware, uploadFile, company.favicon);
router.get("/iam/company/:ID/identity", middleware, company.identity);
