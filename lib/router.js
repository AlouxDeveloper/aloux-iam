...
router.post('/iam/auth/email',                     user.email)
router.post('/iam/auth/login',                     auth.login)
router.post('/iam/auth/forgot/password',           user.recoverpassword) 
router.post('/iam/auth/validate/code',             user.verifyCode) 
router.post('/iam/auth/verify/mail',               user.sendVerifyMailAccount)
router.get('/iam/auth/verify/mail/token/:token',   user.verifyMailTokenAccount)
router.post('/iam/auth/reset/password',            user.resetPassword)
...
router.post('/iam/send/verify/phone',               auth, user.verifyPhone)
router.post('/iam/verify/phone',                    auth, user.validatePhone)
