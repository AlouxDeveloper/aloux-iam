...
router.post('/iam/send/verify/mail',               user.sendVerifyMailAccount)
router.get('/iam/user/verify/mail/token/:token',   user.verifyMailTokenAccount)
...
router.post('/iam/verify/phone',                    auth, user.validatePhoneNumber)
