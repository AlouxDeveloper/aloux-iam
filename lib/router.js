...
router.get('/iam/user/documents/counter',           auth, user.counter)
...
router.get('/iam/functions/documents/counter',      auth, functions.counter)
...
router.get('/iam/permission/documents/counter',     auth, permission.counter)
