...
// User / user self
router.get('/iam/user/me',                          middleware, auth.me)
router.put('/iam/user/profile',                     middleware, user.updateAny)
router.put('/iam/auth/profile/pictura',             middleware, auth.updatePicture)
router.put('/iam/user/reset/password',              middleware, user.resetPass)
